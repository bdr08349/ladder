...
type CreatorFunc func(ctx context.Context, opts map[string]interface{}) (Solver, error)

// Create implements Creator interface
func (f CreatorFunc) Create(ctx context.Context, opts map[string]interface{}) (Solver, error) {
	return f(ctx, opts)
}
